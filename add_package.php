...
<body>
    <form  action="add_package.php"  id= "packageForm" method="post">
        <fieldset>
            ...
            <input type="number" step="0.01" class="input" name="mcoverage" required><br><br>
            
            <label>Payment Interval</label>
            <input type="number" class="input" name="pay_interval" required><br><br>
            
            <label>Premium Amount </label>
            <input type="number" step="0.01" class="input" name="premium_amount" required><br><br>
            
            <label>Regulation </label>
            <textarea class="input" name="regulation" rows="10" cols="50" required></textarea><br><br>
            
            <label>Basic Amount </label>
            <input type="number"  step="0.01" class="input" name="basic_amount" required><br><br>
